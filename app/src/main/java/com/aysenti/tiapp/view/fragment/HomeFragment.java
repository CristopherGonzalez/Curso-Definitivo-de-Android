...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        showToolbar( getResources().getString(R.string.hint_home),false,view);
        RecyclerView picturesRecycler = (RecyclerView)view.findViewById(R.id.home_recyclerview);
    ...
    public ArrayList<Picture> buildPictures(){
        ...
        pictures.add(new Picture("http://www.educationquizzes.com/library/KS3-Geography/river-2-1.jpg", "Juan Pablo", "3 días", "10 Me Gusta"));
